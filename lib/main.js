var _ = require("underscore"),
	...
	Strategy = require("passport-crudr").Strategy;
...
var API = function( options ){
	...
	passport.use(new Strategy({
		...
		callbackURL: "/auth/crudr/callback", // option?
...
API.prototype = {
	...
	auth: function(){
		if( arguments[1] ) {
			return passport.authenticate('crudr', arguments[0], arguments[1]);
		} else {
			return passport.authenticate('crudr', arguments[0]);
		}
	},
